...
def run_simulation( gamma_boost, use_separate_electron_species ):
    ...
    """
    # The simulation box, anode length of NX2
    zmax_lab = 5.e-4    # Length of the box along z (meters)
    zmin_lab = 0.
    ...
    # Define ionization
    #ions.make_ionizable( element='H', level_start=level_start,
...
def test_ionization_labframe():
    run_simulation(1., use_separate_electron_species=False)
